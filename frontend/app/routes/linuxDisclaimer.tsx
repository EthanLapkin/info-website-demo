    ...
    <>
        <section className="hero-section-linux fade-in">
            <p className="hero-subtitle">
              <strong>I will start this with a disclaimer</strong><br/>
              Unlike windows and mac which have unified interfaces, Linux allows the user to pick from a variety of different styles, 
